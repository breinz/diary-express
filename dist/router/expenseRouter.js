...
router.get("/:year(\\d{4})-:month(\\d{1,2})/", expenseMiddleware_1.default.getMonth, expenseMiddleware_1.default.getExpenses, expenseReportMiddleware_1.default.getMonth, expenseController_1.default.getMonth);
