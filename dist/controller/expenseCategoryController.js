...
var ExpenseCategoryController = (function () {
    function ExpenseCategoryController() {
    }
    ExpenseCategoryController.prototype.getIndex = function (req, res, next) {
        res.render("expense/category/index", {
            categories: req.expenseCategories
        });
    };
    ExpenseCategoryController.prototype.getCategory = function (req, res, next) {
        res.render("expense/category/category", {
            category: req.expenseCategory
        });
    };
    ExpenseCategoryController.prototype.getNew = function (req, res, next) {
        res.render("expense/category/new");
    };
    ExpenseCategoryController.prototype.postNew = function (req, res, next) {
    ...
    ExpenseCategoryController.prototype.deleteDelete = function (req, res, next) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
    ...
    ExpenseCategoryController.prototype.getRecover = function (req, res, next) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
    ...
    ExpenseCategoryController.prototype.deleteRemove = function (req, res, next) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
...
var expenseCategoryController = new ExpenseCategoryController();
exports.default = expenseCategoryController;
