...
var ApiCountryController = (function () {
    function ApiCountryController() {
    }
    ApiCountryController.prototype.getCountries = function (req, res, next) {
    ...
    ApiCountryController.prototype.patch = function (req, res, next) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    ApiCountryController.prototype.delete = function (req, res, next) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    return ApiCountryController;
}());
var controller = new ApiCountryController();
