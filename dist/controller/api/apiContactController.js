...
var ApiContactController = (function () {
    function ApiContactController() {
    }
    ApiContactController.prototype.post = function (req, res, next) {
    ...
    return ApiContactController;
}());
var controller = new ApiContactController();
