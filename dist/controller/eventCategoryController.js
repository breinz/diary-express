...
var EventCategoryController = (function () {
    function EventCategoryController() {
    }
    EventCategoryController.prototype.getIndex = function (req, res, next) {
        res.render("event/category/index", {
            categories: req.eventCategories
        });
    };
    EventCategoryController.prototype.getCategory = function (req, res, next) {
        res.render("event/category/category", {
            category: req.eventCategory
        });
    };
    EventCategoryController.prototype.getNew = function (req, res, next) {
        res.render("event/category/new");
    };
    EventCategoryController.prototype.postNew = function (req, res, next) {
    ...
    EventCategoryController.prototype.getEdit = function (req, res, next) {
        res.render("event/category/edit", {
            category: req.eventCategory
        });
    };
    EventCategoryController.prototype.postEdit = function (req, res, next) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
    ...
    EventCategoryController.prototype.deleteDelete = function (req, res, next) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
    ...
    EventCategoryController.prototype.getRecover = function (req, res, next) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
    ...
    EventCategoryController.prototype.deleteRemove = function (req, res, next) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4, EventCategoryModel_1.default.deleteOne({ _id: req.eventCategory._id })];
                    case 1:
                        _a.sent();
...
var eventCategoryController = new EventCategoryController();
exports.default = eventCategoryController;
